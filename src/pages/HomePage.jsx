...
export default function HomePage({
  ...
  const { textPrimary, textSecondary, glassBg, glassBorder } = useTheme()
  ...
  return (
    <div className="relative z-[1] max-w-[1200px] mx-auto px-4 sm:px-8 lg:px-12">
      ...
      <div className="text-center pt-10 sm:pt-16 lg:pt-20 pb-8 sm:pb-12 max-w-[700px] mx-auto">
        {/* Badge drapeau */}
        <div
          className="inline-flex items-center gap-[3px] mb-4 sm:mb-6 px-4 py-1.5 rounded-full backdrop-blur-[10px]"
          style={{
            background: glassBg,
      ...
      {currentQuote && (
        <div className="max-w-[720px] mx-auto mb-10 sm:mb-16">
          <QuoteCard quote={currentQuote} large fadeState={fadeState}>
            <QuoteActions
        ...
        {[
          ...
          >
            <div
              ...
              style={{
                color: i % 2 === 0 ? CI_ORANGE : CI_GREEN,
